...
const findPlayer = async () => {
    ...
    try {
        const response = await axios.get('/api/team/' + form.value.name);
...
<template>
    ...
    <div class="h-screen flex flex-col pb-6">
        <div class="h-full flex flex-col justify-center">
            <div class="-mt-20 max-w-4xl w-full text-center mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-4 flex justify-center items-center">
                    ...
                    <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
                        href="../templates.html" aria-label="Preline">
                ...
                <h1 class="text-3xl font-bold text-gray-800 sm:text-4xl">
                    Bem-vindo ao Dashboard BT
                </h1>
                <p class="mt-3 text-gray-600 dark:text-neutral-400">
                    Agilizando os jogos de Beach Tennis
                </p>
            </div>
            ...
            <div v-if="isLoading" class="text-center text-gray-500 mt-4">Carregando jogador...</div>

            <div class="mt-4 max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-8" v-if="errorMessage">
                        ...
                        <div class="p-4 md:p-5 flex justify-between gap-x-3">
                            <div>
                                ...
                                <div class="flex items-center">
                                    <span class="text-sm font-sm text-gray-400">
                                        Jogos
                                    </span>
                                </div>
                            </div>
        ...
        <footer class="mt-auto max-w-4xl text-center mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-xs text-gray-600 dark:text-neutral-500">© 2025 Desenvolvido por Lucas Awade.</p>
        </footer>
    </div>
    <!-- End Content -->
</template>